...
import com.team.parkky.databinding.ActivityOpMapBinding;
import com.google.android.gms.location.LocationRequest;

public class op_map extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityOpMapBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityOpMapBinding.inflate(getLayoutInflater());
    ...
    public void onMapReady(GoogleMap googleMap) {
     ...
     //  mMap.moveCamera(CameraUpdateFactory.newLatLng(Charusat));
       // mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(Charusat,12f ));
    }
